...
public class NetworkAddressesProvider {
    ...
    public static String getIpAddress() {
        return getAddress(AddressType.IP);
    }

    public static String getMacAddress() {
        return getAddress(AddressType.MAC);
    }

    private static String getAddress(AddressType addressType) {
        String address = "";
